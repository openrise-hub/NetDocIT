...
class TestDiscoveryScanTimeout(unittest.TestCase):
    def test_discover_all_forwards_timeout_to_ping_sweep(self):
        ...
        with patch.dict(sys.modules, {"pysnmp": fake_pysnmp, "pysnmp.hlapi": fake_hlapi}):
            ...
            with patch.object(discovery, "clear_interfaces"), \
                ...
                run_ps_script.assert_called_once_with("ping_sweep.ps1", args=["10.0.0.0/24"], timeout_seconds=45)
