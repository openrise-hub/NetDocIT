...
class TestDiscoveryTimeoutSource(unittest.TestCase):
    def test_discover_all_marks_profile_timeout_source(self):
        ...
        with patch.dict(sys.modules, {"pysnmp": fake_pysnmp, "pysnmp.hlapi": fake_hlapi}):
            ...
            with patch.object(discovery, "clear_interfaces"), \
                ...
                self.assertEqual(result["script_timeout_source"], "profile")

    def test_discover_all_marks_override_timeout_source(self):
        fake_pysnmp = types.ModuleType("pysnmp")
        fake_hlapi = types.ModuleType("pysnmp.hlapi")
        ...
        with patch.dict(sys.modules, {"pysnmp": fake_pysnmp, "pysnmp.hlapi": fake_hlapi}):
            ...
            with patch.object(discovery, "clear_interfaces"), \
                ...
                result = discovery.discover_all(scan_profile="safe", script_timeout_seconds=45)

                self.assertEqual(result["script_timeout_source"], "override")
