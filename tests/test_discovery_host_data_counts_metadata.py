...
class TestDiscoveryHostDataCountsMetadata(unittest.TestCase):
    def test_discover_all_exposes_host_and_snmp_data_counts(self):
        ...
        with patch.dict(sys.modules, {"pysnmp": fake_pysnmp, "pysnmp.hlapi": fake_hlapi}):
            ...
            with patch.object(discovery, "clear_interfaces"), \
                ...
                self.assertEqual(result["host_data_count"], 2)
                self.assertEqual(result["snmp_data_count"], 2)
