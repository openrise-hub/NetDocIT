...
class TestDiscoveryTimeoutCap(unittest.TestCase):
    def test_discover_all_caps_excessive_timeout(self):
        ...
        with patch.dict(sys.modules, {"pysnmp": fake_pysnmp, "pysnmp.hlapi": fake_hlapi}):
            ...
            with patch.object(discovery, "clear_interfaces"), \
                ...
                discovery.discover_all(script_timeout_seconds=99999)

                run_ps_script.assert_called_once_with("ping_sweep.ps1", args=[], timeout_seconds=300)
